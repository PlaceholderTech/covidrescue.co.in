...
export default function Tweet({
  ...
  if (!(text && id && author && created_at && public_metrics)) {
    return <></>;
  }
  ...
  return (
    <div className="tweets-container mt-2">
      {isVerfied(text) && (
        <span className="bg-blue-500 text-gray-50 rounded-md px-2 py-1 text-sm">
          #Verified
        </span>
      )}
      <div
        className={`rounded dark:border-gray-800 px-6 py-4 mb-4 mt-1 w-full ${
          isVerfied(text)
